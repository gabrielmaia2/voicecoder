{
	...
	"configOptions": {
		"getCollections": true,
		"hash": "983963766651d092e46ccf2e6fcf73014675086387818ef3bebfa3ea4d4dae92"
	},
	"priority": 100,
        ...
        return function(t) {
          ...
          var o = function(t2) {
            ...
            return n(e2, t2), e2.prototype.beforeMergeSpace = function(t3) {
              ...
              return "tbody" === this.parentTag || "thead" === this.parentTag ? e3 : t2.prototype.parseOnlyString.call(this, e3, r2, n2);
            }, e2.prototype.exec = function(e3, r2) {
              return void 0 === e3 && (e3 = ""), void 0 === r2 && (r2 = ""), t2.prototype.exec.call(this, e3, r2);
            }, e2;
          }(r(0).default);
          ...
          var c = function(t2) {
            ...
            return n(e2, t2), e2.prototype.parseValidSubTag = function(t3, e3, r2) {
              return "thead" === e3 && (this.exist_thead = true), "tbody" === e3 && (this.exist_tbody = true, this.empty_tbody = false), "tr" === e3 && (this.empty_tbody = false), new ((0, a.getTagConstructor)(e3))(t3, e3, o(o({}, r2), { tableColumnCount: this.tableColumnCount, inTable: true })).exec("", "\n");
            }, e2.prototype.parseOnlyString = function() {
              return "";
            }, e2.prototype.beforeReturn = function(t3) {
...
${obj.stack}]`;
  ...
  function $stringify(key, value, cache) {
    ...
    if (value === null)
      return value;
    if (value.openDialog || value.querySelector)
  ...
  var Logger = class {
    ...
    format({ error = false }, msg) {
      ...
      if (typeof workerEnvironment !== "undefined") {
        prefix += " worker";
        if (typeof workerJob !== "undefined")
          prefix += `${workerJob.translator}`;
      }
      if (error)
        prefix += " error:";
    ...
    get enabled() {
      var _a, _b;
      return typeof workerJob !== "undefined" && workerJob.debugEnabled || !Zotero || ((_a = Zotero.Debug) == null ? void 0 : _a.enabled) || ((_b = Zotero.Prefs) == null ? void 0 : _b.get("debug.store"));
    }
    print(msg) {
      if (!this.enabled)
        return;
...
`;
      ...
      if (this.translation.options.markdown)
        this.markdown = (0, import_html_to_md.default)(this.html);
    }
    show(context, args) {
...
`;
    ...
    item(item) {
      ...
      if (item.itemType === "attachment") {
        ...
        if (item.title)
          title = `<samp>${html(item.title)}</samp>`;
      } else {
